...
*/
#$config['base_url'] = '';
$config['base_url'] = 'http://localhost/clientes/';

# To enable DDD Light autoloading, add 'ddd_autoload' to the autoload helpers array
$autoload['helper'] = array('ddd_autoload');
...
spl_autoload_register(function($class) {
    $paths = [
        APPPATH . 'infrastructure/services/' . $class . '.php',
    ];

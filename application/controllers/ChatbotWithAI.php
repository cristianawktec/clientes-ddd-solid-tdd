...
class Chatbot extends CI_Controller {
    ...
    private function generateGeminiResponse($user_message) {
        ...
        $context = "Você é um assistente virtual especializado no sistema de gerenciamento de clientes desenvolvido em PHP CodeIgniter 3. 
...
TECNOLOGIAS:
- PHP 8.0+, CodeIgniter 3, MySQL/MariaDB, Bootstrap 5, jQuery, PHPUnit

Responda de forma clara e específica sobre o sistema. Mantenha um tom profissional mas amigável.";
